package io.github.absketches.mitbauen.nativeapp.projects.service;

import io.github.absketches.mitbauen.nativeapp.projects.ProjectFeedUtil;
import io.github.absketches.mitbauen.nativeapp.projects.handler.ProjectMutationHandler;
...
import io.github.absketches.mitbauen.nativeapp.projects.media.handler.ProjectMediaHandler;
...
public class ProjectFeedService extends Service {
    ...
    public static final String DEFAULT_PROJECT_FEED_PATH = ProjectFeedUtil.PROJECTS_BASE_PATH;
    ...
    public ProjectFeedService(final DatabaseRuntime databaseRuntime) {
        ...
        this.mutationHandler = new ProjectMutationHandler(databaseRuntime.dataSource());
        this.mediaHandler = new ProjectMediaHandler(databaseRuntime.dataSource());
    }
    ...
    protected void handleGet(final Event<HttpObject, HttpObject> event, final ProjectFeedUtil.RoutesMatch route) {
        ...
        switch (route) {
            ...
            case ProjectFeedUtil.ProjectImagesRoute __ -> ResponseUtil.respondMethodNotAllowed(event, ResponseUtil.METHOD_NOT_ALLOWED_CODE);
